...
const GUEST_LINKS = [
  ...
  { label: "AI Analysis", href: "/ai-stock-analysis" },
  { label: "Options AI", href: "/options-analysis" },
  { label: "Indian Equities", href: "/indian-stock-market-ai" },
  { label: "FAQ", href: "/faq" },
]
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button onClick={() => setMobileOpen((o) => !o)} className="btn btn--icon pressable md:hidden" aria-label="Menu" suppressHydrationWarning>
            {mobileOpen ? (
