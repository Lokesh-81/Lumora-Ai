...
export const metadata = {
  title: "Markets Terminal — Real-Time Stock & Options Explorer | Lumora AI",
  description:
    "Live market quotes, interactive candlestick charts, multi-period technical indicators, dynamic option chains, and on-demand AI analysis for global and Indian equities.",
  alternates: {
    canonical: "https://www.lumoraai.in/markets",
  },
  openGraph: {
    title: "Markets Terminal — Lumora AI",
    description:
      "Live quotes, technical indicators, dynamic option chains, and AI stock analysis.",
    url: "https://www.lumoraai.in/markets",
    type: "website",
